Pod::Spec.new do |s|
  ...
  s.osx.vendored_libraries = 'macosx/lib/*.a'
  s.osx.source_files = 'macosx/include/openssl/*.h'
  s.osx.public_header_files = 'macosx/include/**/*.h'
  s.osx.header_mappings_dir = "macosx/include"

  s.ios.vendored_libraries = 'macosx/lib/*.a'
  s.ios.source_files = 'macosx/include/openssl/*.h'
  s.ios.public_header_files = 'macosx/include/**/*.h'
  s.ios.header_mappings_dir = "macosx/include"
end